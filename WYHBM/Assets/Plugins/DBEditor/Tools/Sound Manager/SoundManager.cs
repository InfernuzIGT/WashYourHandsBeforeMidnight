...
public class SoundManager : MonoBehaviour
{
    ...
    public static int PlayMusic(AudioClip clip, float volume, bool loop)
    {
        return PlayMusic(clip, volume, loop, false, 1f, 1f, -1f, null);
    }
    ...
    public static int PlaySound(AudioClip clip, float volume)
    {
        ...
        return PlaySound(clip, 0, false, null);

        // if (ChatSoundManager.audioOn)
